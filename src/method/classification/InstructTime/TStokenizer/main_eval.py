'''
python src/method/classification/InstructTime/TStokenizer/main_eval.py \
    --data_path = "data/datasets/classification/TimeMixer/har/" \
    --dataset = "har" \
    --device = "cuda"
'''
...
from method.classification.InstructTime.TStokenizer.model import VQVAE
